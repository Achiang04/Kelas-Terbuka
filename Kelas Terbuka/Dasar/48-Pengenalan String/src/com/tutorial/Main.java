...
public class Main {
    public static void main(String[] args) {
        ...
        // itu tidak bisa .... kenapa ?, karena string di java itu immutable (tidak bisa diganti/dirubah)
        kataChar[0] = 'c';
        System.out.println(Arrays.toString(kataChar));
        ...
        // kita bisa merubah komponen String secara tidak langsung
        ...
        3. membuat string dengan method baru, maka dia akaan ditarok di memory lain
            bukan distring pool
         */
