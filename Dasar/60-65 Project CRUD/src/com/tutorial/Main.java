...
//            System.out.println(isExist);
            ...
            // jika keywordsnya cocok maka di tampilkan
    ...
    private static String ambilTahun() throws IOException {
        ...
        while(!tahunValid) {
            try {
                ...
                System.out.println("format tahun tidak tepat, format tahun (YYYY)");
                System.out.print("masukkan tahun terbit lagi, format tahun (YYYY) = ");
                tahunValid = false;
